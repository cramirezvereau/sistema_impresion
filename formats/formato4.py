...
class FormatoPruebaVIHSifilis(BaseTicketFormat):
    """Formato Ticket: Resultado Prueba Rápida VIH/Sífilis (formato compacto)"""
    
    def get_format_name(self):
        return "Resultado_Prueba_Rapida_VIH_Sifilis_Ticket"
    ...
    def get_required_fields(self):
        ...
        return [
            ...
            {
                'name': 'resultado_vih',  # NUEVO CAMPO - COMBO
                'label': 'RESULTADO PRUEBA VIH',
                'type': 'combo',
                'required': True,
                'width': 180,
                'options': [
                    ...
                    {'value': 'C', 'label': 'C - NO SE REALIZO'}
                ],
                'tooltip': 'Seleccione resultado'
            },
            {
                'name': 'resultado_sifilis',  # NUEVO CAMPO - COMBO
                'label': 'RESULTADO PRUEBA SIFILIS',
                'type': 'combo',
                'required': True,
                'width': 180,
                'options': [
    ...
    def generate_image(self, data: dict, **kwargs):
        ...
        resultado_vih = data.get('resultado_vih', '')
        resultado_sifilis = data.get('resultado_sifilis', '')
        ...
        x_hospital = (self.width_px - text_width_hospital) // 2.5
        ...
        # 2. TÍTULO PRINCIPAL
        # ============================================
        titulo_text = "RESULTADO PRUEBA RAPIDA VIH/SIFILIS"
        text_width_titulo = draw.textlength(titulo_text, font=font_bold)
        x_titulo = (self.width_px - text_width_titulo) // 2.5
        ...
        draw.text((250, y_position), fecha_prueba if fecha_prueba else "______", fill='black', font=font_bold)
        y_position += 30
        
        # ============================================
        # 6. MOTIVO DE SOLICITUD (con datos del combo)
        # ============================================
        draw.text((40, y_position), "MOTIVO SOLICITUD:", fill='black', font=font_bold)
        motivo_text = motivo_solicitud if motivo_solicitud else "______"
        if motivo_solicitud == 'A':
            motivo_text = "CONDUCTA DE RIESGO"
        elif motivo_solicitud == 'B':
            motivo_text = "OTROS"
        draw.text((250, y_position), motivo_text, fill='black', font=font_bold)
        y_position += 25
        ...
        # 8. RESULTADO VIH
        # ============================================
        draw.text((40, y_position), "PRUEBA VIH", fill='black', font=font_bold)
        vih_text = resultado_vih if resultado_vih else "______"
        if resultado_vih == 'A':
            vih_text = "REACTIVA"
        elif resultado_vih == 'B':
            vih_text = "NO REACTIVA"
        elif resultado_vih == 'C':
            vih_text = "NO REALIZADA"    
        draw.text((250, y_position), vih_text, fill='black', font=font_bold)
        y_position += 25
        
        # ============================================
        # 9. RESULTADO SÍFILIS
        # ============================================
        draw.text((40, y_position), "PRUEBA SIFILIS", fill='black', font=font_bold)
        sifilis_text = resultado_sifilis if resultado_sifilis else "______"
        if resultado_sifilis == 'A':
            sifilis_text = "REACTIVA"
        elif resultado_sifilis == 'B':
            sifilis_text = "NO REACTIVA"
        elif resultado_sifilis == 'C':
            sifilis_text = "NO REALIZADA"
        draw.text((250, y_position), sifilis_text, fill='black', font=font_bold)
